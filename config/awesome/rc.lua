...
beautiful.init("/home/dialelo/.config/awesome/themes/dialelo/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "m", function () awful.util.spawn(terminal .. " -e mutt -R") end),
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.util.spawn_with_shell("launcher") end),
